...
| `hidden` | boolean | - | If this is set and evaluates to `true`, the row is hidden and not displayed. |
| `condition`<br>**Deprecated** | boolean | - | **Deprecated**. Use `hidden`. If this is set but does not evaluate to `true`, the row is hidden and not displayed. |
